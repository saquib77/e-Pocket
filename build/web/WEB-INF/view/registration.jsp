            ...
            <div class="row">
                <div class="col-md-offset-8 col-md-4">
                    <div class="form-login">
                        ...
                        <input type="text" class="form-control" placeholder="City" value="" name="city" required="required"/>
                        <input type="text" class="form-control" placeholder="State" value=""name="state" required="required"/>
